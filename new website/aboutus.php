...
<head>
    ...
    <title>About Us - Oshein Trading Pvt Ltd</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="card">
                        <img src="logo.png" class="card-img-top product-image" alt="Our Story">
                        <div class="card-body">
                            <h5 class="card-title">Our Story</h5>
                            <p class="card-text">Oshein Trading Pvt. Ltd. was founded in 2012 with a mission to provide high-quality auto parts to the local Sri Lankan market. Starting as a small team of dedicated professionals, we have grown into a reputable name in the auto parts industry. Our specialty lies in importing reconditioned and brand new auto parts directly from Japan. Over the years, we have built a strong relationship with Japanese suppliers, ensuring that our customers in Sri Lanka receive only the best. Our commitment to quality and customer satisfaction has been the cornerstone of our success.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
