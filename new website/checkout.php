...
<head>
    ...
    padding: 1rem; /* Optional: Add padding to the form */
            ...
            <div class="row g-5">
                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        <span style="color:#DB4646;">Your cart</span>
                        <span class="badge rounded-pill"style='background-color:#DB4646;'><?php echo mysqli_num_rows($cart_items); ?></span>
                    </h4>
                            ...
                            while ($item = mysqli_fetch_assoc($cart_items)) {
                                ...
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        ...
                                        <h6 class="my-0"><?php echo 'Qty:' .$item["quantity"]; ?></h6>
                                    </div>
                                    <span class="text-body-secondary">Rs.<?php echo number_format($subtotal, 2); ?></span>
                                </li>
                                <?php
                            }
                            ?>
                            
                            <li class="list-group-item d-flex justify-content-between"style="margin:0;">
                                <span>Total (Rs.)</span>
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation"   method="POST">
                        ...
                        <hr class="my-4">
                        <button class="w-100 button btn-lg"   name="place_order" type="submit">Place Order</button>
                        <?php
include 'connect.php'; // Ensure your database connection script is included

if(isset($_POST['place_order'])){
    // Fetch customer details from POST
    ...
    // Initialize variables for storing product details
    $products = [];
    $price_total = 0;
    ...
    if(mysqli_num_rows($cart_query) > 0){
        while($product_item = mysqli_fetch_assoc($cart_query)){
            ...
            // Accumulate total price of all products
    ...
    // Insert customer order details into database
    $insert_query = "INSERT INTO `customer` (customer_name, email, address, phone_number, city, district, postal_code, total_products, total_price)
                    VALUES ('$customer_name', '$email', '$address', '$phone_number', '$city', '$district', '$postal_code', '$products_json', '$price_total')";
        ...
        echo "<script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'recipt.php?order_id={$order_id}';
                }
            });
        </script>";
